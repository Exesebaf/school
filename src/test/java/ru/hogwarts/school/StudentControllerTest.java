...
public class StudentControllerTest {
    ...
    public void putTest() {
        ...
        ResponseEntity<StudentRecord> getForEntityResponse = testRestTemplate.getForEntity("http://localhost:" + port + "/students/" + studentRecord.getId(), StudentRecord.class);
    ...
    public void findByAgeBetweenTest() {
        ...
        List<StudentRecord> expectedsStudents = studentRecords.stream()
        ...
        assertThat(getForEntityResponse.getBody())
                .hasSize(expectedsStudents.size())
                .usingRecursiveFieldByFieldElementComparator()
                .containsExactlyInAnyOrderElementsOf(expectedsStudents);
    }
